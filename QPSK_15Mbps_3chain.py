...
class QPSK_15Mbps_3chain(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "QPSK_15Mbps_3chain")
        ...
        self.uhd_usrp_sink_0.set_bandwidth(20, 0)
        ...
        self.blocks_file_source_0_0_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/itu/gr-HighDataRate_Modem-main/examples/3048QPSK_PREamble_COMPLEX', True, 0, 0)
        self.blocks_file_source_0_0_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0_0_0_0.set_processor_affinity([2])
        self.blocks_file_source_0_0_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/itu/gr-HighDataRate_Modem-main/examples/Doppler_And_CCSDS_TTC_Flowgraphs_LowRate/32bitASM_CCSDS_only', False, 0, 0)
        self.blocks_file_source_0_0_0.set_begin_tag(pmt.PMT_NIL)
        self.blocks_file_source_0_0_0.set_processor_affinity([1])
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/itu/gr-HighDataRate_Modem-main/examples/FINAL_OUTPUT_FRAMES_ONLY', False)
        ...
        self.HighDataRate_Modem_Tag_FrameASM_xx_1 = HighDataRate_Modem.Tag_FrameASM_bb(2, 32, 1)
        self.HighDataRate_Modem_Tag_FrameASM_xx_1.set_processor_affinity([3])
        ...
        self.HighDataRate_Modem_Resolve_Phase_0 = HighDataRate_Modem.Resolve_Phase(2, 4192, 120000, 1)
        self.HighDataRate_Modem_Resolve_Phase_0.set_processor_affinity([3])
        self.HighDataRate_Modem_Frame_Extract_xx_0 = HighDataRate_Modem.Frame_Extract_bb(4192, 30000, 32)
        self.HighDataRate_Modem_Frame_Extract_xx_0.set_processor_affinity([3])
        ...
        self.connect((self.HighDataRate_Modem_Resolve_Phase_0, 0), (self.blocks_file_sink_0_0, 0))
        ...
        self.connect((self.HighDataRate_Modem_Tag_FrameASM_xx_1, 0), (self.HighDataRate_Modem_Frame_Extract_xx_0, 0))
        ...
        self.connect((self.blocks_file_source_0_0_0, 0), (self.uhd_usrp_sink_0, 0))
        ...
        self.connect((self.blocks_keep_m_in_n_0_1, 0), (self.HighDataRate_Modem_Tag_FrameASM_xx_1, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_keep_m_in_n_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_skiphead_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.blocks_skiphead_0_0, 0))
...
def main(top_block_cls=QPSK_15Mbps_3chain, options=None):
